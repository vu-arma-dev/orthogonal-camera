...
class Ui_Orthogonal_Form(object):
    def setupUi(self, Orthogonal_Form):
        ...
        self.colorChooseBox = QtWidgets.QSpinBox(Orthogonal_Form)
        self.colorChooseBox.setMaximum(3)
        self.colorChooseBox.setObjectName("colorChooseBox")
        self.gridLayout_3.addWidget(self.colorChooseBox, 0, 0, 1, 1)
        ...
        self.saveBtn = QtWidgets.QPushButton(Orthogonal_Form)
        self.saveBtn.setObjectName("saveBtn")
        self.horizontalLayout_2.addWidget(self.saveBtn)
        self.loadBtn = QtWidgets.QPushButton(Orthogonal_Form)
    ...
    def retranslateUi(self, Orthogonal_Form):
        ...
        self.saveBtn.setText(_translate("Orthogonal_Form", "Save Thresh"))
        self.loadBtn.setText(_translate("Orthogonal_Form", "Load Thresh"))
